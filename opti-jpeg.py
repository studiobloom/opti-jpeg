...
def set_console_title():
    ctypes.windll.kernel32.SetConsoleTitleW("Opti-JPEG")
...
def get_icon_path():
    if hasattr(sys, '_MEIPASS'):
        return os.path.join(sys._MEIPASS, 'opti-jpeg.ico')
    else:
        return os.path.join(os.path.dirname(os.path.abspath(__file__)), 'opti-jpeg.ico')
